...
export const get = (componentName, hash) => {
    ...
    return allManifest === null || allManifest === void 0 ? void 0 : allManifest[componentName][hash];
};
/** returns an array of table contents */
export const getAll = (componentName, filter) => {
    var _a;
    const all = Object.values((_a = allManifest === null || allManifest === void 0 ? void 0 : allManifest[componentName]) !== null && _a !== void 0 ? _a : {});
