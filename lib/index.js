...
var D2Manifest = /** @class */ (function () {
    ...
    D2Manifest.prototype.latest = function () {
        ...
        return _a = manifestsByVersion[0], (_a !== null && _a !== void 0 ? _a : '');
    };
    /**
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 4, , 5]);
                        latestManifest = this.latest().replace('.json', '');
                    ...
                    case 3:
                        ...
                        this.verbose &&
                            console.log("writing manifest with " + Object.keys(manifest).length + " keys\nto file: " + (this.manifestsPath +
