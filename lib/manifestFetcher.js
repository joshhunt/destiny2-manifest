...
function httpClient(config) {
    return cross_fetch_1.default(config.url, config)
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, (versionMismatch && manifest_1.getDestinyManifestComponent(httpClient, { destinyManifest: manifestMetadata, tableName: tableName, language: language }))];
            }
        });
    });
}
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, !alreadyUpdated && manifest_1.getAllDestinyManifestComponents(httpClient, { destinyManifest: manifestMetadata, language: language })];
            }
        });
    });
}
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, (versionMismatch &&
                            manifest_1.getDestinyManifestSlice(httpClient, { destinyManifest: manifestMetadata, tableNames: tableNames, language: language }))];
            }
        });
    });
}
