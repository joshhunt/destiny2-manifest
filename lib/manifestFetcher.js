        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, (versionMismatch && api_ts_getter_1.getDestinyManifestTable(httpClient, { destinyManifest: manifestMetadata, tableName: tableName, language: language }))];
            }
        });
    });
}
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (verbose)
                        console.log((ignoreIfVersion && versionMismatch ? "bungie.net has a manifest version that isn't " + ignoreIfVersion + " " : '') + "downloading version " + manifestMetadata.version);
                    return [2 /*return*/, versionMismatch && api_ts_getter_1.getAllDestinyManifestTables(httpClient, { destinyManifest: manifestMetadata, language: language })];
            }
        });
    });
}
