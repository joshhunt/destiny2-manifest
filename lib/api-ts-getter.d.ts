import { DestinyActivityDefinition, DestinyActivityGraphDefinition, DestinyActivityModeDefinition, DestinyActivityModifierDefinition, DestinyActivityTypeDefinition, DestinyArtifactDefinition, DestinyBreakerTypeDefinition, DestinyChecklistDefinition, DestinyClassDefinition, DestinyCollectibleDefinition, DestinyDamageTypeDefinition, DestinyDestinationDefinition, DestinyEnergyTypeDefinition, DestinyEquipmentSlotDefinition, DestinyFactionDefinition, DestinyGenderDefinition, DestinyInventoryBucketDefinition, DestinyInventoryItemDefinition, DestinyItemCategoryDefinition, DestinyItemTierTypeDefinition, DestinyLocationDefinition, DestinyLoreDefinition, DestinyManifest, DestinyMaterialRequirementSetDefinition, DestinyMetricDefinition, DestinyMilestoneDefinition, DestinyObjectiveDefinition, DestinyPlaceDefinition, DestinyPlugSetDefinition, DestinyPresentationNodeDefinition, DestinyProgressionDefinition, DestinyProgressionLevelRequirementDefinition, DestinyProgressionMappingDefinition, DestinyRaceDefinition, DestinyRecordDefinition, DestinyReportReasonCategoryDefinition, DestinyRewardSourceDefinition, DestinySandboxPerkDefinition, DestinySeasonDefinition, DestinySeasonPassDefinition, DestinySocketCategoryDefinition, DestinySocketTypeDefinition, DestinyStatDefinition, DestinyStatGroupDefinition, DestinyTalentGridDefinition, DestinyTraitCategoryDefinition, DestinyTraitDefinition, DestinyUnlockDefinition, DestinyUnlockValueDefinition, DestinyVendorDefinition, DestinyVendorGroupDefinition, HttpClient } from 'bungie-api-ts/destiny2';
/**
...
export declare type DestinyManifestTableName = keyof DestinyManifestStructure;
/**
 ...
 */
export declare type DestinyDefinitionFrom<K extends DestinyManifestTableName> = DestinyManifestStructure[K][number];
